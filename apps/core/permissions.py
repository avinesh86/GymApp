...
class IsInvoiceParticipant(TenantPermission):
    """Anyone involved in the invoice workflow: instructors (their own),
    managers/admins (approval), and payroll (payment). Object/queryset scoping
    restricts instructors to their own invoices."""
