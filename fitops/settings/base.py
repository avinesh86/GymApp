...
WSGI_APPLICATION = "fitops.wsgi.application"
ASGI_APPLICATION = "fitops.asgi.application"
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "apps.core.exceptions.fitops_exception_handler",
}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "FitOps API",
    "DESCRIPTION": "Multi-tenant gym operations platform API",
    "VERSION": "1.0.0",
